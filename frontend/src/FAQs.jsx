...
const FAQ_DATA = [
    ...
    },
    {
        ...
        a: 'Admin accounts have full access to the system including issue tracking and report generation. User accounts have read-only access to the dashboard statistics, charts, and map views, with limited property details (PIN, area, and land use only).'
    },
    {
